...
def generate_position(n_particles, dimensions, bounds, discrete_index):
    ...
    pos_cont = np.around(pos_cont,decimals=6)
...
class Traffic(Topology):
    ...
    def compute_pbest(self, swarm, iter):
        ...
        # print("pc",new_pbest_cost)
        # print("pp",new_pbest_pos)
        # print("pa",new_pbest_aux)
    ...
    def compute_position(
        ...
        temp_position[:, :swarm.discrete_index] = np.around(temp_position[:, :swarm.discrete_index],decimals=6)
