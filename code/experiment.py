...
if __name__ == '__main__':
    ...
    data_path="../custom_extractor_data"
    percent_theta=0.1
    target=0
    ...
    # dr=DataReader(data_path, 0.2, 0.2, dataset_name=dataset_name, use_filename_as_label=True)
    ...
    # adversarial_generation(dataset_name, model_path, target, "train", num_samples=100, fixed=fixed, theta=0.01,scale=False)
