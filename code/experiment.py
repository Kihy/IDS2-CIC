...
if __name__ == '__main__':
    ...
    include_file=["Wednesday-14-02-2018_TrafficForML_CICFlowMeter.csv"]
    ...
    format_converter("../pcap_data/", "../experiment/column_map.csv")
    predict_sample("patator400.pcap_Flow.csv", model_path, dataset_name)
