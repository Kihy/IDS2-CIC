...
if __name__ == '__main__':
    ...
    adversarial_generation(dataset_name, model_path, target, "train", num_samples=100, theta=0.01)
    # format_converter("../pcap_data/", "../experiment/column_map.csv", out_dir="../custom_data/", metadata=False, use_filename_as_label=True)
    # predict_sample("slowloris.pcap_Flow.csv", model_path, dataset_name)
